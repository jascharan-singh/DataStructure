...
//        LinkedList<Integer> nonEmptyList = new LinkedList<>();
...
//
//        // Test case 2
//        if (!list.isPresent(new LinkedList<Integer>().getFirst())) {
